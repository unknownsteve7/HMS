...
const PaymentStatus = ({ type = 'success' }) => {
        ...
        const cardRef = useRef(null); // 👈 reference for PDF capture
...
const downloadPDF = async () => {
  ...
  const imgWidth = pageWidth * 0.85; // scale to 85% of width
  ...
  pdf.save(`receipt_${txnid || "transaction"}.pdf`);
};
