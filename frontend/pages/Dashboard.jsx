        ...
        <Card>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center mt-6">
              ...
              <div>
                <p className="text-xl font-bold text-accent-orange">₹{(financialOverview.advanceCollected || 0).toLocaleString()}</p>
                <p className="text-xs text-text-medium">Advance Collected</p>
              </div>
              <div>
                <p className="text-xl font-bold text-red-500">₹{(pendingBalance || 0).toLocaleString()}</p>
