...
export default defineConfig({
  ...
  server: {
    allowedHosts: ['localhost', 'believe-moderators-apparently-cordless.trycloudflare.com', 'sg-active-kinda-examine.trycloudflare.com', 'favourites-extend-beauty-permanent.trycloudflare.com'],
    port: 5173,
    strictPort: true,
  },
  preview: {
